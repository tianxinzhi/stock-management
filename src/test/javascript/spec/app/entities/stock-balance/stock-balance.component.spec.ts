...
import { StockBalanceComponent } from 'app/entities/stock-balance/stock-balance.component';
...
describe('Component Tests', () => {
  describe('StockBalance Management Component', () => {
    let comp: StockBalanceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StockBalanceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.stockBalances && comp.stockBalances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
